...
def LCX_vessel_curve(sample_size, mean_ctrl_pts,  length, rng,  shear=False, warp=False):
    '''
...
def branched_tree_generator(parent_curve, curve_derivative, num_branches, sample_size, side_branch_properties, curve_type="spline"):
    ...
    curve_type (string): "spline" for spline_tube, "cylinder" for cylinder, "RCA" for RCA ,"LAD" for LAD , "LCX" for LCX
    '''
